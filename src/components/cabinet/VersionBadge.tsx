...
const CHANGELOG = [
  { v: "v4.3", note: "Реальное фото со стройки (загружает ГИП в S3) + AI-генератор стилей отделки на FLUX (6 пресетов: модерн, классика, сканди, лофт, дерево, премиум)" },
  { v: "v4.2", note: "Авто-дашборд для заказчика: интерактивный дом-конструктор из 13 этапов, оплата, обратный отсчёт, линия этапов. В навигации убраны иконки + плавный синий hover за курсором" },
